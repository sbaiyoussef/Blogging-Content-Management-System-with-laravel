...
use App\Http\Requests\tagsRequest\CreateTagsRequest;
use App\Http\Requests\tagsRequest\UpdateTagsRequest;
use App\Post;
use App\Tag;
...
class TagsController extends Controller
{
    ...
    public function destroy(Tag $tag)
    {
        if($tag->posts->count()>0){
            session()->flash('error','tag cannot be deleted because it has a post');
